    ...
    ui <- navbarPage(
        ...
        tabPanel(
            ...
            tags$figure(
                class = "centerFigure",
                tags$img(
                    src = paste0(system.file("www", package = "CRCAtlas"),
                                 "/Welcome Page.png"),
                    width = "1350px",
                    height = "450px",
        ...
        tabPanel(
            ...
            fluidRow(
                column(4, img(src = paste0(system.file("www", package = "CRCAtlas"),
                                           "/Deconv_Fig.png"), 
    ...
    server <- function(input, output, session) {
        ...
        observeEvent(input$inquire_stat_button, {
            output$displayImg <- renderUI({
                img(src = paste0(system.file("www", package = "CRCAtlas"), 
                    "/GEM_Statistics/", input$catype_dropdown, "/",
            ...
            output$displaydot <- renderUI({
                img(src = paste0(system.file("www", package = "CRCAtlas"),
                                 "/dotplot/", input$catype_dropdown, ".png"),
                    height = "700px", width = "700px")
            })
        })
